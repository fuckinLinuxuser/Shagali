...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showsData = {
        "Скрипичное Шоу": {
            ...
            img: "../public/images/projects/skripka-show.jpg",
    ...
    const visitedCitiesData = {
        "vladivostok": {
            ...
            img: "../public/cities/vladivostok.jpg", // ← положи реальное фото
            type: "visited"
        }
